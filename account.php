...
if (!$action){
	...
	$hash = sha1($CURUSER["id"].$CURUSER["secret"].$CURUSER["password"].getip().$CURUSER["secret"]);
	...
	<b><?php echo "Cookie 'UID'"; ?>:</b> <?php echo $CURUSER["id"]; ?><br />
	<b><?php echo T_("COOKIE"); ?>:</b> <?php echo $hash; ?><br />
	<?php
