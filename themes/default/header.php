...
<body>
    <div class='wrapper'>
      <!-- START HEADER -->
      <div class='header'> <a class='logo' href='index.php' title='Home' target='_self'><img style="float:left;margin-left:-40px;" src='<?php echo $site_config["SITEURL"]; ?>/themes/default/images/logo.gif' alt='logo' width='940' height='72' /></a>
        <!-- Start Infobar -->
        <div class='infobar'>
          <?php
                if (!$CURUSER){
      ...
      <div class='navigation'>
        <div class='menu'>
          <ul id='nav-one' class='dropmenu'>
			...
			<li><a href='animeTeke.php'><?php echo T_("INDICE_ANIME");?></a></li>
