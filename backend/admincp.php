...
if ($action == "forum") {
    ...
    if ($_POST["do"] == "add_this_forum") {
        ...
        if ($error_ac == "") {
            ...
            if ($res)
                autolink("admincp.php?action=forum", "Gracias, nuevo foro añadido a la base de datos...");
            else
                echo "<h4>No pudo grabarse en la Base de Datos - ¡Comprueba conexión y ajustes!</h4>";
        } 
    }
    ...
    if ($_POST["do"] == "add_this_forumcat") {
        ...
        if ($error_ac == "") {
            ...
            if ($res)
                autolink("admincp.php?action=forum", "Gracias, nueva categoría añadida a los foros...");
            else
                echo "<h4>No pudo grabarse en la Base de Datos - ¡Comprueba conexión y ajustes!</h4>";
        } 
    }
    ...
    if ($_POST["do"] == "delete_forumcat" && is_valid_id($_POST["id"])) 
    {
        ...
        autolink("admincp.php?action=forum", "Categoría de foro borrada ...");
    }
    
    stdhead("Gestión de Foros");
