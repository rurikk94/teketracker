...
if ($action=="messagespy"){                                    
 ...
 if ($action == "torrentmanage") {
        ...
        list($pagertop, $pagerbottom, $limit) = pager(100, $count, "admincp.php?action=torrentmanage&amp;");
        
        $res = SQL_Query_exec("SELECT id, name, seeders, leechers, visible, banned, external FROM torrents $where ORDER BY name $limit");
        
        stdhead("Gestión de Torrents");
        navmenu();
        
        begin_frame("Gestión de Torrents");
        ...
        Buscar: <input type='text' name='search' value='<?php echo $search; ?>' size='30' />
        ...
        <tr>
            ...
            <th class='table_head'>Baneado</th>
            <th class='table_head'>Semillas</th>
            <th class='table_head'>Sanguijuelas</th>
            <th class='table_head'>Externo</th>
            <th class='table_head'>Editar</th>
        ...
        <tr>
            <td class='table_col1'><a href='torrents-details.php?id=<?php echo $row["id"]; ?>'><?php echo CutName(htmlspecialchars($row["name"]), 80); ?></a></td>
